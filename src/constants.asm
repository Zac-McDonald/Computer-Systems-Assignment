...
; constants.asm
; Defines important constants for use across the entire project and performs setup code
...
UPDATE_RATE = $208D	;$07A120 = 500ms = 2Hz, $C350 = 50ms = 20Hz, $8235 = 30Hz, $411A = 60Hz
